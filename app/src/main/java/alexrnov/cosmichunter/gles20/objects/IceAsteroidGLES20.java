...
public class IceAsteroidGLES20 extends Object3D implements AsteroidGLES20 {
  ...
  public IceAsteroidGLES20(Context context, float scale) { //, TypeAsteroid type) {
    ...
    LinkedProgram2 linkProgram = new LinkedProgram2(context,
            ...
            "shaders/gles20/ice_asteroid_f.glsl"); // линковать программу
