...
public class ExplosionGLES20 {
  ...
  private List<ExplosionGLES20> explosions;

  public ExplosionGLES20(Context context, String textureFile) {
    this(context, textureFile, 0.05f,
            0.6f, 100.0f, 150, new float[] {1.0f, 0.7f, 0.1f, 1.0f});
  }

  public ExplosionGLES20(Context context, String textureFile, float startRadius,
  ...
  public void setExplosions(List<ExplosionGLES20> explosions) {
