...
public class Explosion2 {
  ...
  private List<Explosion2> explosions;

  public Explosion2(Context context, String textureFile) {
    this(context, textureFile, 0.05f,
            0.6f, 100.0f, 150, new float[] {1.0f, 0.7f, 0.1f, 1.0f});
  }

  public Explosion2(Context context, String textureFile, float startRadius,
    ...
    LinkedProgram2 linkProgram = new LinkedProgram2(context,
            "shaders/explosion_v2.glsl",
            "shaders/explosion_f2.glsl");
  ...
  public void draw(float delta) {
    ...
    GLES20.glVertexAttribPointer(0, 1, GLES20.GL_FLOAT, false, 4, 0);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);

    GLES20.glEnableVertexAttribArray(1);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, VBO[1]);
    GLES20.glVertexAttribPointer(1, NUM_COORDINATES, GLES20.GL_FLOAT,
            false, FLOAT_SIZE * NUM_COORDINATES, 0);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);

    GLES20.glEnableVertexAttribArray(2);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, VBO[2]);
    GLES20.glVertexAttribPointer(2, NUM_COORDINATES, GLES20.GL_FLOAT,
            false, FLOAT_SIZE * NUM_COORDINATES, 0);
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);
    ...
    GLES20.glDisableVertexAttribArray(0); // отключить атрибут времени жизни
    GLES20.glDisableVertexAttribArray(1); // отключить атрибут начальных координат
    GLES20.glDisableVertexAttribArray(2); // отключить атрибут конечных координат
  ...
  public void setExplosions(List<Explosion2> explosions) {
