...
public class IceAsteroidObject3D2 extends Object3D2 implements Asteroid2 {
  ...
  public IceAsteroidObject3D2(Context context, float scale) { //, TypeAsteroid type) {
    ...
    LinkedProgram2 linkProgram = new LinkedProgram2(context,
            "shaders/ice_asteroid_v2.glsl",
            "shaders/ice_asteroid_f2.glsl"); // линковать программу
