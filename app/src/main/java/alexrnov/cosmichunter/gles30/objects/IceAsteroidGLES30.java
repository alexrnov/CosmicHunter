...
public class IceAsteroidGLES30 extends Object3D implements AsteroidGLES30 {
  ...
  public IceAsteroidGLES30(Context context, float scale) { //, TypeAsteroid type) {
    ...
    LinkedProgramGLES30 linkProgram = new LinkedProgramGLES30(context,
            ...
            "shaders/gles30/ice_asteroid_f.glsl"); // линковать программу
