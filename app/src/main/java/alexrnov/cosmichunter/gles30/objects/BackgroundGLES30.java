...
public class BackgroundGLES30 extends Object3D {
  ...
  public BackgroundGLES30(Context context, float scale) {
    super(context, scale, R.raw.fone);
    final LinkedProgramGLES30 linkProgram = new LinkedProgramGLES30(context,
    ...
    textureID = TextureGLES30.loadTextureFromRaw(context, R.raw.sky_texture); //загрузить текстуру
