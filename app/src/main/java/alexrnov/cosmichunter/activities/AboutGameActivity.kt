...
class AboutGameActivity: AppCompatActivity() {
  ...
  override fun onCreate(bundle: Bundle?) {
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
      supportActionBar?.title = Html.fromHtml("<font color=\"#ffffff\" size=\"26\">" + "Об игре" + "</font>", Html.FROM_HTML_MODE_LEGACY)
    } else {
      @Suppress("DEPRECATION")
      supportActionBar?.title = Html.fromHtml("<font color=\"#ffffff\" size=\"26\">" + "Об игре" + "</font>")
    }
    */
    ...
    /**
     * Провести анимацию после измерения и отображения лэйаута на экране.
