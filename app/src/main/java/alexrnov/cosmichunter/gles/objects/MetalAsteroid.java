...
public class MetalAsteroid extends Object3D implements Asteroid {
  ...
  public MetalAsteroid(double versionGL, Context context, float scale, String objectPath) { //, TypeAsteroid type) {
    ...
    textureID = loadTextureWithMipMapFromRaw(context, R.raw.metal_texture); //загрузить текстуру
