...
public class Level5 implements GLSurfaceView.Renderer, SceneRenderer {
  ...
  private int numbersOfRockets = 55; // количество оставшихся ракет
  ...
  public Level5(double versionGL, Context context) {
    //Log.i(TAG, "versionGL = " + versionGL + ", Level5");
  ...
  public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
    ...
    */
    ...
    asteroids[0] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[0], activeExplosions, versionGL, context);
    asteroids[1] = new GasAsteroid(versionGL, context, 1.0f,"objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[1], activeExplosions, versionGL, context);
    asteroids[2] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[2], activeExplosions, versionGL, context);
    asteroids[3] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[3], activeExplosions, versionGL, context);

    asteroids[4] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[4], activeExplosions, versionGL, context);
    asteroids[5] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    bindExplosions(asteroids[5], activeExplosions, versionGL, context);
    asteroids[6] = new GasAsteroid(versionGL, context, 1.0f, "objects/vulcan_asteroid.obj");
    ...
    backgroundObject3D = new Background(versionGL, context, 160.0f, R.raw.sky_texture_level5);
  ...
  public void onDrawFrame(GL10 glUnused) { // вызывается при перерисовке кадра
    ...
    for (Asteroid asteroid: asteroids) {
      ...
      if (asteroid.getView().checkHit(flyRockets)) {
        ...
        int needNumberOfHints = 50;
        if (numberOfHints == needNumberOfHints) {
