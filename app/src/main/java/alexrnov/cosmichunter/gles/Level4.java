...
import alexrnov.cosmichunter.gles.objects.Planet;
...
public class Level4 implements GLSurfaceView.Renderer, SceneRenderer {
  ...
  private int numbersOfRockets = 60; // количество оставшихся ракет
  ...
  public void onSurfaceCreated(GL10 glUnused, EGLConfig config) {
    ...
    */
    ...
    asteroids[0] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[0], activeExplosions, versionGL, context);
    asteroids[1] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[1], activeExplosions, versionGL, context);
    asteroids[2] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[2], activeExplosions, versionGL, context);
    asteroids[3] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[3], activeExplosions, versionGL, context);

    asteroids[4] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[4], activeExplosions, versionGL, context);
    asteroids[5] = new VulcanAsteroid(versionGL, context, 1.0f);
    bindExplosions(asteroids[5], activeExplosions, versionGL, context);
    asteroids[6] = new VulcanAsteroid(versionGL, context, 1.0f);
    ...
    backgroundObject3D = new Background(versionGL, context, 160.0f, R.raw.sky_texture_level4);
    planet = new Planet(versionGL, context, 1.0f, "objects/planet.obj");
      ...
      if (asteroid.getView().checkHit(flyRockets)) {
        ...
        if (numberOfHints == needNumberOfHints && !gameActivity.timeOver) {
          ...
          AsyncTask.execute(() -> {
            ...
            dao.updateLevel("level5", true); // открыть следующий уровень
          });
