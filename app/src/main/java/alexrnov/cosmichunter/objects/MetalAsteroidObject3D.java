...
public class MetalAsteroidObject3D extends Object3D implements Asteroid {
  ...
  public MetalAsteroidObject3D(Context context, float scale) { //, TypeAsteroid type) {
    ...
    LinkedProgram linkProgram = new LinkedProgram(context,
            "shaders/asteroid_v.glsl",
            "shaders/asteroid_f.glsl"); // линковать программу
