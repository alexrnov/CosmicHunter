...
class PlanetView3D(widthScreen: Int, heightScreen: Int):
  ...
  private val modelViewMatrix2 = FloatArray(16)
  override fun spotPosition(delta: Float) {
    ...
    Matrix.multiplyMM(modelViewMatrix2, 0, viewMatrix, 0, modelMatrix, 0)
  ...
  fun getMV2MatrixAsFloatBuffer(): FloatBuffer = Buffers.floatBuffer(modelViewMatrix2)
